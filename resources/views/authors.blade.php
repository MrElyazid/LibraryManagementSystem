...
<div class="container mt-4">
    ...
    <div class="row">
        @foreach ($authors as $author)
            <div class="col-lg-4 col-md-6 d-flex justify-content-center">
                <div class="card author-card d-flex flex-row align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#authorModal{{$loop->iteration}}">
                            Read description
                        </button>
                    </div>
                </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="authorModal{{$loop->iteration}}" tabindex="-1" aria-labelledby="authorModalLabel{{$loop->iteration}}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="authorModalLabel{{$loop->iteration}}">{{ $author->name }} {{ $author->lastname }}</h5>
