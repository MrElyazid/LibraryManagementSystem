...
<body>
    ...
    <!-- resources/views/partials/howto-section.blade.php -->
            ...
            <div class="col-md-4 text-center">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Our site is your one-stop destination for amazing book rentals. Discover a wide range of genres, authors, and titles. Happy reading!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Browse our collection, choose your favorite books, and rent them out with just a few clicks. Enjoy reading and return the books when you are done!</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="bi bi-check-circle-fill text-primary"></i> Author & Category Browsing</li>
                                <li><i class="bi bi-check-circle-fill text-primary"></i> User Profile & History</li>
                            </ul>
                        </p>
                    </div>
                </div>
